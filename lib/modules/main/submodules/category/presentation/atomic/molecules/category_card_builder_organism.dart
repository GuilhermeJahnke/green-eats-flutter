...
class CategoryCardBuilderOrganism extends StatelessWidget {
  ...
  List<Widget> _buildTermGroups(List<Category> termsList) {
    final groupedTerms = Utils.groupElements<Category>(termsList, groupSize: 2);
  ...
  Widget build(BuildContext context) {
    final termGroups = _buildTermGroups(categoryList);
